...
6. classify the full impact surface before editing.
...
For architecture, protocol, state-machine, authentication/authorization, journal/evidence, publication, recovery, or trust-boundary changes:
